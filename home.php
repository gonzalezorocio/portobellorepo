...
<html>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:480px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/comida.jpg" />
                <img data-u="thumb" src="img/comidach.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/bebida.jpg" />
                <img data-u="thumb" src="img/bebidach.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/postre.jpg" />
                <img data-u="thumb" src="img/postrech.jpg" />
            </div>
    ...
    <script type="text/javascript">jssor_1_slider_init();</script>
						<p><a href="completo.php" class="button button-slider">Ver menú completo</a>
            		</div>
            	</div>
			</div>
